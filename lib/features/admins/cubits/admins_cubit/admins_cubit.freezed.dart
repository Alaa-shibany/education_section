...
mixin _$AdminsState {
 ...
 SubmissionStatus get status; PaginationModel<AdminModel>? get data; String? get errorMessage;
/// Create a copy of AdminsState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AdminsStateCopyWith<AdminsState> get copyWith => _$AdminsStateCopyWithImpl<AdminsState>(this as AdminsState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminsState&&(identical(other.status, status) || other.status == status)&&(identical(other.data, data) || other.data == data)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@override
String toString() {
  return 'AdminsState(status: $status, data: $data, errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $AdminsStateCopyWith<$Res>  {
  factory $AdminsStateCopyWith(AdminsState value, $Res Function(AdminsState) _then) = _$AdminsStateCopyWithImpl;
@useResult
$Res call({
 SubmissionStatus status, PaginationModel<AdminModel>? data, String? errorMessage
});
...
/// @nodoc
class _$AdminsStateCopyWithImpl<$Res>
    implements $AdminsStateCopyWith<$Res> {
  _$AdminsStateCopyWithImpl(this._self, this._then);

  final AdminsState _self;
  final $Res Function(AdminsState) _then;
...
as PaginationModel<AdminModel>?,errorMessage: freezed == errorMessage ? _self.errorMessage : errorMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
/// Adds pattern-matching-related methods to [AdminsState].
extension AdminsStatePatterns on AdminsState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SubmissionStatus status,  PaginationModel<AdminModel>? data,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SubmissionStatus status,  PaginationModel<AdminModel>? data,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState():
return $default(_that.status,_that.data,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SubmissionStatus status,  PaginationModel<AdminModel>? data,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
return $default(_that.status,_that.data,_that.errorMessage);case _:
  return null;
...
class _CreateTeacherState implements AdminsState {
...
@override final  PaginationModel<AdminModel>? data;
...
/// @nodoc
abstract mixin class _$CreateTeacherStateCopyWith<$Res> implements $AdminsStateCopyWith<$Res> {
