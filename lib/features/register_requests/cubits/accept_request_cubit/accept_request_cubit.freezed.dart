...
/// Create a copy of AcceptRequestState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AcceptRequestStateCopyWith<AcceptRequestState> get copyWith => _$AcceptRequestStateCopyWithImpl<AcceptRequestState>(this as AcceptRequestState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AcceptRequestState&&(identical(other.status, status) || other.status == status)&&(identical(other.data, data) || other.data == data)&&(identical(other.failure, failure) || other.failure == failure));
}
...
@override
String toString() {
  return 'AcceptRequestState(status: $status, data: $data, failure: $failure)';
}
...
/// @nodoc
abstract mixin class $AcceptRequestStateCopyWith<$Res>  {
  factory $AcceptRequestStateCopyWith(AcceptRequestState value, $Res Function(AcceptRequestState) _then) = _$AcceptRequestStateCopyWithImpl;
@useResult
$Res call({
...
class _$AcceptRequestStateCopyWithImpl<$Res>
  ...
  _$AcceptRequestStateCopyWithImpl(this._self, this._then);

  final AcceptRequestState _self;
...
/// Adds pattern-matching-related methods to [AcceptRequestState].
extension AcceptRequestStatePatterns on AcceptRequestState {
...
class _CreateTeacherState implements AcceptRequestState {
...
/// @nodoc
abstract mixin class _$CreateTeacherStateCopyWith<$Res> implements $AcceptRequestStateCopyWith<$Res> {
