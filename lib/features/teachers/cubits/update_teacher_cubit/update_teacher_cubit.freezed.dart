...
mixin _$UpdateTeacherState {
 ...
 SubmissionStatus get status; UpdatedTeacherResponse? get data; Failure? get failure; List<SubjectModel> get selectedBooks;
...
@override
String toString() {
  return 'UpdateTeacherState(status: $status, data: $data, failure: $failure, selectedBooks: $selectedBooks)';
}
...
@useResult
$Res call({
 SubmissionStatus status, UpdatedTeacherResponse? data, Failure? failure, List<SubjectModel> selectedBooks
});
...
as UpdatedTeacherResponse?,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SubmissionStatus status,  UpdatedTeacherResponse? data,  Failure? failure,  List<SubjectModel> selectedBooks)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SubmissionStatus status,  UpdatedTeacherResponse? data,  Failure? failure,  List<SubjectModel> selectedBooks)  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState():
return $default(_that.status,_that.data,_that.failure,_that.selectedBooks);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SubmissionStatus status,  UpdatedTeacherResponse? data,  Failure? failure,  List<SubjectModel> selectedBooks)?  $default,) {final _that = this;
switch (_that) {
case _CreateTeacherState() when $default != null:
return $default(_that.status,_that.data,_that.failure,_that.selectedBooks);case _:
  return null;
