...
/// @nodoc
class $UpdateTeacherStateCopyWith<$Res>  {
$UpdateTeacherStateCopyWith(UpdateTeacherState _, $Res Function(UpdateTeacherState) __);
}
...
class _Initial implements UpdateTeacherState {
  const _Initial();
...
@override
String toString() {
  return 'UpdateTeacherState.initial()';
}
...
class _Loading implements UpdateTeacherState {
  const _Loading();
...
@override
String toString() {
  return 'UpdateTeacherState.loading()';
}
...
class _Success implements UpdateTeacherState {
...
@override
String toString() {
  return 'UpdateTeacherState.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $UpdateTeacherStateCopyWith<$Res> {
...
class _Error implements UpdateTeacherState {
...
@override
String toString() {
  return 'UpdateTeacherState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $UpdateTeacherStateCopyWith<$Res> {
