...
import 'package:courses/features/students/repo/students_repository.dart';
...
Future<void> setupServiceLocator() async {
  ...
  sl.registerFactory(() => GetStudentsCubit(sl()));
  sl.registerLazySingleton(() => StudentsRepository(sl()));
}
